...
class AddProgram extends StatefulWidget {
  int id;
  AddProgram({required this.id});

  @override
  State<AddProgram> createState() => _AddProgramState(id);
}

class _AddProgramState extends State<AddProgram> {
  int id;
  late DatabaseReference dbref;
  _AddProgramState(this.id);
  ...
  void initState() {
    super.initState();
    dbref = FirebaseDatabase.instance.ref().child("Schedule/$id");
  }
