...
class editProgram extends StatelessWidget {
  const editProgram({Key? key}) : super(key: key);
...
class _EditProgramState extends State<EditProgram> {
  ...
  @override
  void initState() {
    dateController.text = "30-9-2023";
    timeController.text = "12:30"; //default text
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        SizedBox(height: 25,),
        Text("     Edit your program:",style: TextStyle(fontWeight: FontWeight.bold,fontSize:23),textAlign:TextAlign.left,),
        SizedBox(height: 50,),
        Form(key: _formKey,
            child:Column(
                ...
                Container(
                  ...
                  child:TextButton(onPressed:() {
                    MessageDialog(dialogBackgroundColor: Colors.grey[50],
                      ...
                      , child: Text('Edit program',style: TextStyle(color: Colors.black87),)),
                )
              ],
            )
